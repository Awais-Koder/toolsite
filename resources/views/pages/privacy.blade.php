...
@section('content')
    ...
    <section class="-mx-gutter -mt-section-gap pt-24 pb-10 md:pt-28 md:pb-12 bg-gradient-to-br from-primary-container/20 via-background to-secondary-fixed/15 relative overflow-hidden">
        <div class="max-w-[1200px] mx-auto px-gutter" data-reveal="fade-up">
            ...
            <h1 class="font-display text-display text-on-surface mb-3">Privacy Policy</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-gutter">
            ...
            <div class="hidden lg:block lg:col-span-1">
                <div class="sticky top-24 bg-surface-container-lowest rounded-2xl shadow-xs border border-outline-variant/40 p-6" data-reveal="fade-up">
                    ...
                    <nav class="space-y-2">
                        <a href="#introduction" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Introduction</a>
                        <a href="#log-files" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Log Files</a>
                        <a href="#cookies" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Cookies</a>
                        <a href="#advertising" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Advertising Partners</a>
                        <a href="#third-party" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Third-Party Policies</a>
                        <a href="#consent" class="block text-sm text-on-surface-variant hover:text-secondary transition-colors">Consent</a>
                    </nav>
                </div>
            </div>
